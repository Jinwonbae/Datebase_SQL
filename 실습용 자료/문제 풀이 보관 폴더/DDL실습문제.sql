...
INSERT INTO TB_PUBLISHER VALUES (1,'플레이스테이션', '010-4444-7777');
INSERT INTO TB_PUBLISHER VALUES (2,'엑스박스', '010-5555-7878');
INSERT INTO TB_PUBLISHER VALUES (3,'닌텐도', '010-1818-8282');
...
CREATE TABLE TB_BOOK(
    ...
    BK_AUTHOR VARCHAR2(50) CONSTRAINT BOOK_NN_AUTHER NOT NULL,
    BK_PRICE NUMBER,
...
INSERT INTO TB_BOOK VALUES (1,'플스가 하고싶다','정찬복',50000,1);
INSERT INTO TB_BOOK VALUES (2, '닌텐도가 하고싶다','정찬복',60000,2);
INSERT INTO TB_BOOK VALUES (3, '무허가 홈카페','박민지',20000,3);
INSERT INTO TB_BOOK VALUES (3000,'아이언맨','로다쥬',200000,2);
INSERT INTO TB_BOOK VALUES (44444,'MVC활용하기','강보람',7777777,3);
...
CREATE TABLE TB_MEMBER(
    ...
    GENDER CHAR(1) CONSTRAINT MEMBER_CK_GENDER CHECK(GENDER IN ('M','F')),
...
-- 5개 정도의 샘플 데이터 추가하기
INSERT INTO TB_MEMBER VALUES(1,'USER01','PASS01','먼지','M','지구','010-1111-1111',DEFAULT,DEFAULT); 
INSERT INTO TB_MEMBER VALUES(2,'USER02','PASS02','봉지','M','지구','010-2211-2211',DEFAULT,DEFAULT); 
INSERT INTO TB_MEMBER VALUES(3,'USER03','PASS03','휴지','M','지구','010-3311-3311',DEFAULT,DEFAULT); 
INSERT INTO TB_MEMBER(MEMBER_NO,MEMBER_ID,MEMBER_PWD,MEMBER_NAME,GENDER) VALUES(4,'USER04','PASS04','요지','F');
INSERT INTO TB_MEMBER(MEMBER_NO,MEMBER_ID,MEMBER_PWD,MEMBER_NAME,GENDER) VALUES(5,'USER05','PASS05','메주','F');
...
INSERT INTO TB_RENT VALUES(1,2,3,DEFAULT);
INSERT INTO TB_RENT VALUES(2,4,2,DEFAULT);
INSERT INTO TB_RENT VALUES(3,5,1,DEFAULT);



-- 도서대여한 회원, 대여 도서명 확인 쿼리
-- ANSI
SELECT RENT_MEM_NO 대여회원번호,
       MEMBER_NAME 회원명,
       RENT_BOOK_NO 대여도서번호,
       BK_TITLE 도서명,
       RENT_DATE 대여일
...
-- ORACLE
SELECT R.RENT_MEM_NO 대여회원번호,
       M.MEMBER_NAME 회원명,
       R.RENT_BOOK_NO 대여도서번호,
       B.BK_TITLE 도서명,
       R.RENT_DATE 대여일
       
FROM TB_RENT R, TB_MEMBER M, TB_BOOK B
